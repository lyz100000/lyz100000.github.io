...
window.addEventListener('load', function () {
    ...
    const font = new FontFace(
        "MiSans",
        "url(https://cdn2.mengluo.work/MiSans-Regular.woff2)"
    );
...
const add_id = "pcqxiumwtj9ftnrw"; // app_id
const app_secret = "N3M2MGZZaFJtckRSRCsrcGJiaFNpUT09"; // app_secret
const key = "bb3a906b24704820aa3970781daeabe1" // key
function getWeather() {
...
主页:  https://mengluo.work
Github:  https://github.com/meng-luo
`
